...
echo -e "${BLUE}  scaffold list                      # List available scripts${NC}"
echo -e "${BLUE}  scaffold add setup script.sh       # Add a script${NC}"
echo -e "${BLUE}  scaffold setup my-project          # Run a script${NC}"
echo -e "${BLUE}  ss -l                              # Use shorthand${NC}"
echo ""
